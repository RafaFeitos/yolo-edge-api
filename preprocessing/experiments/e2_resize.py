...
def demo_bbox_adjustment():
    ...
    cv2.rectangle(frame_lb, tuple(bbox_lb[0, :2].astype(int)), tuple(bbox_lb[0, 2:].astype(int)), (0, 255, 0), 2)
    cv2.rectangle(frame, tuple(bbox_orig[0, :2].astype(int)), tuple(bbox_orig[0, 2:].astype(int)), (0, 255, 0), 2)
